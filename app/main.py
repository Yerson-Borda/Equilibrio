...
from app.api.v1 import users, wallets, transactions, categories, analytics
...
app = FastAPI(
    ...
    description="Backend API for personal finance management application with real-time updates",
    version="1.0.0"
)
...
# Include all routers (removed sync router)
...
def root():
    return {
        ...
        "docs": "/docs",
        "redoc": "/redoc",
        "features": ["authentication", "wallet_management", "transaction_tracking", "real_time_updates"]
    }
