...
const BudgetGauge = ({ budget = 0, spent = 0, currencySymbol = '$', month }) => {
    ...
    const formatMoney = (v) => `${currencySymbol}${v.toFixed(2)}`;

    // Helper to compute knob position on the arc
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
                <svg width="240" height="130" viewBox="0 0 240 130">
                    ...
                    <path
                        ...
                        strokeLinecap="round"
                        strokeDasharray="180"
                        strokeDashoffset={180 - (percentage / 100) * 180}
