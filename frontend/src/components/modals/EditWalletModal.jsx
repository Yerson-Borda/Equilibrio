...
const EditWalletModal = ({ isOpen, onClose, onSubmit, isLoading, wallet }) => {
    ...
    const validate = () => {
        ...
        if (!formData.name.trim()) newErrors.name = "Wallet name is required";
        ...
        if (formData.card_number) {
            const digits = String(formData.card_number).replace(/\s/g, "");
            if (digits.length !== 16) newErrors.card_number = "Card number must be 16 digits";
        }
    ...
    const handleSubmit = (e) => {
        ...
        const submitData = {
            ...
            card_number: String(formData.card_number).replace(/\s/g, ""),
        };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[99999]">
            <div className="flex flex-col items-center space-y-4 mt-4">
                ...
                >
                    <div className="text-left mb-2">
                        <h3 className="text-base font-semibold">{formData.name || "T-Банк"}</h3>
                    </div>
            ...
            <span className="tracking-wider font-mono text-lg font-semibold">
              {formatCardNumber(formData.card_number) || "5495 7381 3759 2321"}
                ...
                {/* Form box (same size/layout as CreateWalletModal) */}
                <div className="bg-white rounded-xl shadow-lg p-6" style={{ width: "345px", height: "660px" }}>
                  ...
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
                    {currentCurrencySymbol}
                                ...
                                {errors.initial_balance && (
                                    <p className="mt-1 text-xs text-red-500">{errors.initial_balance}</p>
                                )}
                            </div>
                        ...
                        {/* Buttons (same placement as CreateWalletModal) */}
