    ...
    return (
        <div className="w-full">
            ...
            <div className="flex items-center justify-between pb-5 border-b border-strokes">
                ...
                <Toggle
                    value={notifications.receiveNotifications}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-8">
                <div className="space-y-10">
                    <div className="flex items-center justify-between">
                        ...
                        <Toggle
                            value={notifications.notifyWhenExceedLimit}
                            onClick={() => handleToggle('notifyWhenExceedLimit')}
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Toggle
                            value={notifications.reminderToLogExpenses}
                            onClick={() => handleToggle('reminderToLogExpenses')}
                        />
                    </div>
                </div>
                ...
                <div className="flex items-start justify-between">
                    ...
                    <Toggle
                        ...
                        onClick={() => handleToggle('forecasts')}
                    />
                </div>
            </div>
            ...
            <div className="pt-16">
                <Button
                    ...
                    onClick={() => alert("Notifications updated (hook this to API)")}
                >
                    Update
                </Button>
            </div>
